package com.sf.aspro.hi_library.util
 ...
 */
object AppGlobals {
    private var applicattion: Application? = null
    fun get(): Application? {
        if (applicattion == null) {
            try {
                applicattion = Class.forName("android.app.ActivityThread")
